"""Offline v0.24.23 integration self-check. No MT5 orders and no AI/API calls."""
...
def main() -> int:
    ...
    checks={
      'version_0_24_23': (root/'VERSION').read_text().strip()=='0.24.23',
    ...
    print(json.dumps({'atlas_version':'0.24.23','mode':'OFFLINE_STAGING_SELFCHECK','checks':checks,'passed':not failed,'failed':failed,'zero_ai_calls':True,'orders_sent':False},indent=2))
