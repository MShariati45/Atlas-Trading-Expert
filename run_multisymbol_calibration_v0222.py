...
WINDOWS=[
 ('2014_A', datetime(2014,2,3,tzinfo=timezone.utc), datetime(2014,2,14,23,59,tzinfo=timezone.utc)),
 ('2016_A', datetime(2016,6,13,tzinfo=timezone.utc), datetime(2016,6,24,23,59,tzinfo=timezone.utc)),
 ('2018_A', datetime(2018,10,15,tzinfo=timezone.utc), datetime(2018,10,26,23,59,tzinfo=timezone.utc)),
 ('2020_A', datetime(2020,9,21,tzinfo=timezone.utc), datetime(2020,10,2,23,59,tzinfo=timezone.utc)),
 ('2021_A', datetime(2021,5,3,tzinfo=timezone.utc), datetime(2021,5,14,23,59,tzinfo=timezone.utc)),
]
...
(ROOT/'multisymbol_calibration_v0222.json').write_text(json.dumps({'summary':summary,'windows':[{k:v for k,v in r.items() if k!='events'} for r in all_results]},indent=2),encoding='utf-8')
with (ROOT/'multisymbol_events_v0222.csv').open('w',newline='') as f:
